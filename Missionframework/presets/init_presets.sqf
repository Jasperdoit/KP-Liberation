...
switch (KP_liberation_preset_resistance) do {
    ...
    case  9: {[] call compileFinal preprocessFileLineNumbers "presets\resistance\customrhs.sqf";};
...
switch (KP_liberation_preset_civilians) do {
    ...
    case  8: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\IDAP.sqf";};
