...
infantry_units = [
    ...
    */
    // US Army
    ["B_Soldier_lite_F",15,0,0],
    ["B_Soldier_F",20,0,0],
    ["B_soldier_LAT_F",30,0,0],
    ["B_Soldier_GL_F",25,0,0],
    ["B_soldier_AR_F",25,0,0],
    ["B_HeavyGunner_F",35,0,0],
    ["B_soldier_M_F",30,0,0],
    ["B_Sharpshooter_F",40,0,0],
    ["B_soldier_AT_F",50,10,0],
    ["B_soldier_AA_F",50,10,0],
    ["B_medic_F",30,0,0],
    ["B_engineer_F",30,0,0],
    ["B_soldier_exp_F",30,0,0],
    // USMC
    ["Marine_B_USMC_Soldier_F",20,0,0],
    ["Marine_B_USMC_Soldier_LAT_F",30,0,0],
    ["Marine_B_USMC_Soldier_GL_F",25,0,0],
    ["Marine_B_USMC_Soldier_AR_F",25,0,0],
    ["Marine_B_USMC_soldier_M_F",30,0,0],
    ["Marine_B_USMC_soldier_AT_F",50,10,0],
    ["Marine_B_USMC_soldier_AA_F",50,10,0],
    ["Marine_B_USMC_medic_F",30,0,0],
    ["Marine_B_USMC_engineer_F",30,0,0],
    // British Armed Forces
    ["B_A_Soldier_Lite_F",15,0,0],
    ["B_A_Soldier_CQ_F",15,0,0],
    ["B_A_Soldier_F",20,0,0],
    ["B_A_Soldier_LAT_F",30,0,0],
    ["B_A_Soldier_GL_F",25,0,0],
    ["B_A_Soldier_AR_F",25,0,0],
    ["B_A_HeavyGunner_F",35,0,0],
    ["B_A_soldier_M_F",30,0,0],
    ["B_A_Soldier_AT_F",50,10,0],
    ["B_A_Soldier_AA_F",50,10,0],
    ["B_A_Medic_F",30,0,0],
    ["B_A_Engineer_F",30,0,0],
    ["B_A_Soldier_Exp_F",30,0,0],
    // Bundeswehr
    ["Atlas_B_G_Soldier_Lite_F",15,0,0],
    ["Atlas_B_G_Soldier_F",20,0,0],
    ["Atlas_B_G_Soldier_LAT_F",30,0,0],
    ["Atlas_B_G_Soldier_GL_F",25,0,0],
    ["Atlas_B_G_Soldier_AR_F",25,0,0],
    ["Atlas_B_G_HeavyGunner_F",35,0,0],
    ["Atlas_B_G_soldier_M_F",30,0,0],
    ["Atlas_B_G_Soldier_AT_F",50,10,0],
    ["Atlas_B_G_Soldier_AA_F",50,10,0],
    ["Atlas_B_G_Medic_F",30,0,0],
    ["Atlas_B_G_Engineer_F",30,0,0],
    ["Atlas_B_G_Soldier_Exp_F",30,0,0],
    /*
    ========================
         --- Recon ---
    ========================
    */
    ["B_recon_F",20,0,0],
    ["B_recon_LAT_F",30,0,0],
    ["B_recon_M_F",30,0,0],
    ["B_Recon_Sharpshooter_F",40,0,0],
    ["B_recon_medic_F",30,0,0],
    ["B_recon_exp_F",30,0,0],
    // British Armed Forces
    ["B_A_Recon_F",20,0,0],
    ["B_A_Recon_CQ_F",20,0,0],
    ["B_A_Recon_LAT_F",30,0,0],
    ["B_A_Recon_M_F",30,0,0],
    ["B_A_Recon_Sharpshooter_F",40,0,0],
    ["B_A_Recon_Medic_F",30,0,0],
    ["B_A_Recon_Exp_F",30,0,0],
    // Bundeswehr
    ["Atlas_B_G_Recon_F",20,0,0],
    ["Atlas_B_G_Recon_LAT_F",30,0,0],
    ["Atlas_B_G_Recon_M_F",30,0,0],
    ["Atlas_B_G_Recon_Medic_F",30,0,0],
    ["Atlas_B_G_Recon_Exp_F",30,0,0],
    /*
    ========================
         --- Misc ---
    ========================
    */
    ["B_sniper_F",70,5,0],
    ["B_ghillie_ard_F",70,5,0],
    ["B_ghillie_lsh_F",70,5,0],
    ["B_ghillie_sard_F",70,5,0],
    ["B_spotter_F",20,0,0],
    ["B_crew_F",10,0,0],
...
light_vehicles = [
    ...
    ["B_A_MRAP_03_F",100,0,50],                                           // Strider
    ["B_A_MRAP_03_hmg_F",100,40,50],                                      // Strider (HMG)
    ["B_A_MRAP_03_gmg_F",100,60,50],                                      // Strider (GMG)
...
heavy_vehicles = [
    ["Atlas_B_G_LT_01_scout_F",200,0,125],                                      // AWC 302 Nyx (AA)
    ["B_APC_Wheeled_01_cannon_v2_F",200,75,125],                           // AMV-7 Marshall
    ["Atlas_B_G_APC_Wheeled_03_cannon_F",200,75,125],                           // AFV-4 Gorgon
    ["B_APC_Tracked_01_rcws_F",300,100,150],                            // IFV-6c Panther
    ["B_A_APC_tracked_03_cannon_v2_F",300,150,150],                          // FV-720 Mora
    ["B_APC_Tracked_01_AA_F",300,250,175],                              // IFV-6a Cheetah
    ["Atlas_B_G_LT_01_AA_F",300,250,175],                                       // AWC 302 Nyx (AA)
    ["Atlas_B_G_LT_01_AT_F",300,250,175],                                       // AWC 302 Nyx (AT)
    ["Atlas_B_G_LT_01_cannon_F",300,250,175],                                   // AWC 302 Nyx (Cannon)
    ["B_MBT_01_cannon_F",400,300,200],                                  // M2A1 Slammer
    ["Atlas_B_G_MBT_03_cannon_F",400,300,200],                                  // MBT-52 Kuma
...
air_vehicles = [
    ...
    ["B_Heli_Light_01_dynamicLoadout_F",200,100,100],                   // AH-9 Paw
    ["B_A_Heli_light_03_unarmed_F",225,0,125],                            // WY-55 Hellcat
    ["B_A_Heli_light_03_dynamicLoadout_F",225,200,125],                   // WY-55 Hellcat (Armed)
    ...
    ["B_A_Heli_Transport_02_F",275,0,175],                                // CH-49 Mohawk
    ["Atlas_B_G_Heli_Transport_02_F",275,0,175],                                // CH-49 Mohawk
    ...
    ["B_A_Plane_Fighter_05_F",1000,1200,400],                             // A-149 Gryphon
    ["B_A_Plane_Fighter_05_Stealth_F",1000,1200,400],                             // A-149 Gryphon
...
elite_vehicles = [
    ...
    "B_A_Plane_Fighter_05_F",                                             // A-149 Gryphon
    "B_AFV_Wheeled_01_cannon_F",                                             // A-149 Gryphon
    "B_AFV_Wheeled_01_up_cannon_F",                                             // A-149 Gryphon
    "B_A_Plane_Fighter_05_Stealth_F",                                             // A-149 Gryphon
